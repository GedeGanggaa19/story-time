    ...
    <div>
      ...
      <template v-else-if="story">
        ...
        <nav class="breadcrumb container-fluid fontDmSans">
          ...
          <NuxtLink to="/stories" class="breadcrumb-item"><span>Stories</span></NuxtLink>
        </nav>
          ...
          <article class="detail-content">
            ...
            <div class="row content-wrapper mb-5">
              <div class="col-md-4 pe-4">
                <img 
                  :src="`${ngrokUrl}/storage/${story.content_images[0].path}`" 
                  :alt="story.title" 
                  class="cover-image" 
                />
            ...
            <div class="bookmark-icon" @click="toggleBookmark"></div>
          </article>

    ...
    methods: {
      async fetchStory() {
        try {
          ...
          const response = await fetch(`https://0fac-103-190-47-10.ngrok-free.app/api/stories/${this.storyId}`, {
            method: 'GET',
            headers: {
      ...
      async fetchCategories() {
        try {
          const authStore = useAuthStore();
          const response = await fetch('https://0fac-103-190-47-10.ngrok-free.app/api/categories', {
            method: 'GET',
            headers: {
              'Accept': 'application/json',
